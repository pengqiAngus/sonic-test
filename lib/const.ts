...
export const CONNECTION_STATE_LABEL: Record<ConnectionState, string> = {
  ...
  reconnecting: "Reconnecting",
  "closed-connection": "Close Connection"
};
...
export const SOLANA_STREAM_STATUS = {
  ...
  RECONNECTING: "reconnecting",
  CLOSED: "closed",
  CLOSED_CONNECTION: "close-connection"
} as const;

export type SolanaStreamStatus = (typeof SOLANA_STREAM_STATUS)[keyof typeof SOLANA_STREAM_STATUS];
...
export const SOLANA_MACHINE_STATE_TO_STATUS = {
  ...
  closedConnection: SOLANA_STREAM_STATUS.CLOSED_CONNECTION
} as const;
...
export const SOLANA_STREAM_STATUS_BADGE_CLASS: Record<SolanaStreamStatus, string> = {
  ...
  "close-connection": "rounded-full bg-rose-100 px-3 py-1 text-xs font-semibold text-rose-700"
};
